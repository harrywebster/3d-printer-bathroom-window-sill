...
"""Bathroom window-sill draining board — v3 geometry. Every parameter lives here.

v3 changes no geometry: it exists because v2 shipped a 3MF that Bambu Studio
opened with every part on plate 1, outside the bed. The fix is in build.py.
Everything below is v2 unchanged.
